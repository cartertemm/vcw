...
Brainwave entrainment and soundscape sculpting. A single-file, zero-dependency web app inspired by papers on the impact of sonic frequencies on mood (creativity, focus and concentration, etc).
...
- [ ] Add soundscapes to complement webaudio based noise generation
